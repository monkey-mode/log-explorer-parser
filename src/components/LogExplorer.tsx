  ...
  return (
    <div className="flex flex-col h-screen bg-slate-950 text-slate-300 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto">
        {allLogs.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full gap-5 text-slate-500">
            ...
            {extData ? (
              <div className="flex flex-col items-center gap-1 text-sm">
                <div className="flex items-center gap-2 text-green-400 font-medium">
                  ...
                  Cookie Bridge active — {extData.indexPattern ?? extData.baseUrl}
                </div>
                <span className="text-slate-500 text-xs">Logs will appear automatically when you click Send</span>
              </div>
            ) : (
              <div className="flex flex-col items-center gap-1 text-sm">
                <div className="flex items-center gap-2 text-slate-400">
                  <span className="w-2 h-2 rounded-full bg-slate-600 animate-pulse" />
                  Waiting for Cookie Bridge
                </div>
                <span className="text-slate-600 text-xs">Open your OSD tab → click the extension icon → Send</span>
              </div>
            )}

            <p className="text-xs text-slate-600">or drag &amp; drop a CSV / JSON file</p>
          </div>
